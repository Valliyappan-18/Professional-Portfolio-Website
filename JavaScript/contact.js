...
function sendMessage(){
    ...
    Host : "smtp.elasticemail.com",
        ...
        Subject : "User Details and Message",
        Body :document.querySelector('.fname').value + " " + document.querySelector('.lname').value + " " + document.querySelector('.email').value + " "+document.querySelector('.city').value + " "+document.querySelector('.usermessage').value
    }).then(
      message => {
        if(message=="OK"){
